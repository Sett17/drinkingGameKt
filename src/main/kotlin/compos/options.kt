...
fun options(): HTMLDivElement {
    return document.create.div {
        onMouseOverFunction = { _ ->
            if (attributes["updated"] != "true") {
                console.log("joooo")
                ...
                if (isMobile()) {
                    js("document.querySelectorAll(\".options-wrapperInside\").forEach(function (el) {el.style.flexDirection = 'column'})")

                } else {
                    js("document.querySelectorAll(\".options-wrapperInside\").forEach(function(el){el.style.flexDirection = 'row'})")
                }
            }
        }
        id = "root"
